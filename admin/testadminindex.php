        ...
        $(document).ready(function () {
            ...
            function filter_data() {
                ...
                $.ajax({
                    url: "fetch_data.php",
                    method: "POST",
                    data: { action: action, minimum_price: minimum_price, maximum_price: maximum_price, brand: brand, ram: ram, processor: processor, graphics: graphics },
